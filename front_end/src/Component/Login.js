        ...
        return (
            <div className="contain">
                ...
                <p>Data Models should be entered as alphabetical characters only. <br />
                    ...
                    Filters are optional. Each filter entered must be space separated. </p>
                <div className="input-box">
                    ...
                    <input type="text" value={this.state.filters} onChange={this.handleUpdate} name="filters" style={{width: '100%'}} />
